...
class WorkshopAllocationController extends Controller
{
    ...
    {
        $data = $request->validate(['source_hash' => 'required|string|size:64', 'revision' => 'nullable|string', 'override' => 'nullable|boolean', 'supplied_categories' => 'sometimes|array|max:100', 'supplied_categories.*' => 'boolean', 'targets' => 'required_if:override,1|array|min:1', 'targets.*' => 'required|numeric|min:0|max:10000000']);
