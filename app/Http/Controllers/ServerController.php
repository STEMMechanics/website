...
class ServerController extends Controller
{
    ...
    private function getServerInfo(): array
    {
        ...
        return [
            ...
            'Media Downloads via Apache X-Sendfile' => Helpers::isApacheXSendfileAvailable() ? 'Enabled' : 'Disabled',
            'Media Downloads via Nginx X-Accel' => Helpers::isNginxXAccelEnabled() ? 'Enabled ('.Helpers::mediaXAccelPrefix().')' : 'Disabled',
