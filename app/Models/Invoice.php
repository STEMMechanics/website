...
class Invoice extends Model
{
    ...
    protected $casts = [
        ...
        'scheduled_review_sent_at' => 'datetime',
        'scheduled_email_queued_at' => 'datetime',
        'scheduled_email_sent_at' => 'datetime',
        'scheduled_email_failed_at' => 'datetime',
        'email_template_set' => 'boolean',
