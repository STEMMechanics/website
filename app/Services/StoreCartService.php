...
class StoreCartService
{
    ...
    public function payload(array $options = []): array
    {
        ...
        return [
            ...
            'has_selected_shipping_method' => $this->shippingMethodCode() !== null,
            ...
            'summary' => [
                ...
                'item_gst' => round((float) ($summary['item_gst'] ?? 0), 2),
                'shipping_gst' => round((float) ($summary['shipping_gst'] ?? 0), 2),
                'discount_gst' => round((float) ($summary['discount_gst'] ?? 0), 2),
                ...
                'coupon_type' => $summary['coupon_type'] ?? null,
