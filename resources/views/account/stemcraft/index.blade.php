        ...
        <div class="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_22rem]">
            ...
            <section class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
                <h2 class="text-lg font-semibold text-gray-900">STEMCraft overview</h2>
                    ...
                    <section class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
                        <h2 class="text-lg font-semibold text-gray-900">{{ $canCreateAccounts ? 'Before you add an account' : 'Need help linking an account?' }}</h2>
                        <div class="mt-4 space-y-4 text-sm leading-6 text-gray-600">
                            ...
                            @else
                            <p>This page is available for inspection only. You can review linked accounts and their stats.</p>
                            <p>If you need a Minecraft username linked, contact support.</p>
                        @endif
                    </div>
                </section>
