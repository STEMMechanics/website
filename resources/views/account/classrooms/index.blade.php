...
<x-layout>
    <x-mast description="Open the courses you are enrolled in or have access to through your workshop group.">Courses</x-mast>
            ...
            <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
                <div class="max-w-3xl">
                    ...
                    <p class="mt-3 text-base leading-7 text-gray-600">
                        Courses appear here when you are enrolled directly or included through a workshop access group. Open a course to join the live room, view instructions, and follow the session notes.
                    </p>
                </div>

                @if(! $hasClassrooms)
                    <div class="mt-8 rounded-3xl border border-dashed border-gray-300 bg-gray-50 p-6">
                        <h2 class="text-lg font-semibold text-gray-900">No courses yet</h2>
                        <p class="mt-2 text-sm leading-6 text-gray-600">
                            If your teacher has added you to a course or workshop group, it will show up here after you sign in.
                        </p>
            ...
            <aside class="space-y-4">
                <section class="rounded-3xl border border-gray-200 bg-white p-5 shadow-sm">
                    ...
                    <p class="mt-3 text-sm leading-6 text-gray-600">
                        Courses are linked to your website account through enrolments or workshop access groups. If your teacher adds a new term, it will appear here automatically after you log in.
                    </p>
                </section>
