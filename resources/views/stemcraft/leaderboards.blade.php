                                ...
                                <div class="flex items-center justify-between gap-4 rounded-2xl bg-gray-50 px-4 py-3">
                                    <div class="min-w-0">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="min-w-0">
                                                <div class="truncate text-sm font-semibold text-gray-900">{{ $row['username'] }}<span class="truncate text-xs font-mono text-gray-500 font-normal ml-2">({{ $row['platform'] ?? 'Java' }})</span></div>
                                            </div>
                                        </div>
                                    </div>
