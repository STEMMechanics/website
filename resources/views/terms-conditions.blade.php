<x-layout>
    <x-mast>Terms and Conditions</x-mast>
    <x-container class="pt-8">
        ...
        <x-heading class="mt-8">1. Eligibility, registration & account</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">2. Ownership of site content</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">3. Hyperlinks</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">5. Rights in user content</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">6. Feedback</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">7. User conduct</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">8. No third-party beneficiaries</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">9. Indemnification</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">>10. Disclaimers</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">11. Liability</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">12. Modifications to site</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">13. Termination</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">14. Severability</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">15. Ordering online</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">16. Pricing & availability</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">17. Errors</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">18. Out of stock / pre-order items</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">19. Agreement to Conduct Transactions Electronically; Recording; Copies</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">20. Payment</x-heading>
        <p class="mb-2">
        ...
        <x-heading class="mt-8">21. Third-party sellers / on-sellers (buying & selling)</x-heading>
        <p class="mb-2">
