@if(!empty($holdExpiresAt))
    <div class="absolute top-0 right-0 z-10 m-4 rounded-lg border border-amber-300 bg-amber-50 p-2 text-sm shadow-md" x-data="SM.workshopHoldCountdown(@js($holdExpiresAt), @js($workshop->id))" x-cloak>
