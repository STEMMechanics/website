<x-layout>
    <x-finance.cost-centre-mast title="Allocation Plans">
        <x-slot:actions><x-ui.button color="mast" :href="route('admin.product-allocation.profiles')">Product profiles</x-ui.button><x-ui.button color="mast" data-record-editor href="{{ route('admin.cost-centre.allocations', ['tab' => 'editor']) }}">Create</x-ui.button></x-slot:actions>
