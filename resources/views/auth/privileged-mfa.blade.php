<x-layout :bodyClass="'image-background'">
    <x-dialog formaction="{{ route('security.mfa.verify') }}">
        ...
        <x-slot:header>
            <div class="min-w-0 flex-1">Enter a code from your authenticator app, or one of your unused backup codes.</div>
            <a href="{{ route('logout.show') }}" class="link shrink-0 self-start">Log out</a>
        </x-slot:header>
