<template>
    <SMContainer class="terms">
        ...
        <p>
            ...
            (drustcraft.com.au) and online services (collectively, the "Sites")
            of Drustcraft Pty Ltd. ("Drustcraft"). The Terms do not alter in any
            way the terms or conditions of any other agreement you may have with
            Drustcraft, or our subsidiaries or affiliates, for products,
            services or otherwise. If you are using the Sites on behalf of any
            entity, you represent and declare that you are authorized to accept
            these Terms on such entity's behalf and that such entity agrees to
            indemnify you and Drustcraft for its violations of these Terms.
        </p>
