<template>
    <SMPage class="rules">
        ...
        <p>
            These are NOT a complete set of everything you can and can't do with
            STEMMechanics staff and its helpers determining each offense on a
            case-by-case basis.
        </p>
        ...
        <ul>
            ...
            <li>
                <strong>No Racism / Hate Speech</strong> - Is not accepted under
                any circumstance.
            </li>
            <li>
            ...
            <li>
                <strong>No Advertising</strong> - Referencing or pointing out a
                service is ok.
            </li>
        ...
        <ul>
            ...
            <li>
                <strong>No Hacking Mods</strong> - Jesus, Camera, Dupes are all
                included. Mini-maps are ok.
            </li>
            <li>
