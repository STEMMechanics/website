...
Route::middleware(['admin', 'nocache'])->group(function () {
    ...
    Route::get('/admin/allocation-overrides/{kind}', [\App\Http\Controllers\BulkAllocationOverrideController::class, 'edit'])->whereIn('kind', ['invoices', 'expenses'])->name('admin.allocation-overrides.edit');
